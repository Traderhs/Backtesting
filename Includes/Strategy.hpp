...
#include "Logger.hpp"
#include "Order.hpp"         // 커스텀 전략에서 사용 편의성을 위해 직접 포함
#include "OrderHandler.hpp"  // 커스텀 전략에서 사용 편의성을 위해 직접 포함
#include "Plot.hpp"
 ...
 *    (프로젝트 폴더/Backboard/Includes/Strategies/클래스명.hpp 그리고
 *     프로젝트 폴더/Backboard/Sources/Strategies/클래스명.cpp)\n
 *
 ...
 private:  // indicators_를 먼저 초기화 시키기 위하여 protected보다 위에 위치
  ...
  void AutoDetectSourcePaths() {
    ...
    const vector<string>& header_candidates = {
        format("{}/Backboard/Includes/Strategies/{}.hpp", project_directory,
               class_name),
        format("{}/Backboard/Includes/Strategies/{}.hpp", project_directory,
               name_)};
    ...
    const vector<string>& source_candidates = {
        format("{}/Backboard/Sources/Strategies/{}.cpp", project_directory,
               class_name),
        format("{}/Backboard/Sources/Strategies/{}.cpp", project_directory,
               name_)};
