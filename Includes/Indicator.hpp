...
#include "BarData.hpp"     // 커스텀 지표에서 사용 편의성을 위해 직접 포함
#include "BarHandler.hpp"  // 커스텀 지표에서 사용 편의성을 위해 직접 포함
#include "Config.hpp"
 ...
 *    (프로젝트 폴더/Backboard/Includes/Indicators/클래스명.hpp 그리고
 *     프로젝트 폴더/Backboard/Sources/Indicators/클래스명.cpp)\n
 */
class Indicator {
 ...
 public:
  ...
  void AutoDetectSourcePaths() {
    ...
    const vector<string>& header_candidates = {
        format("{}/Backboard/Includes/Indicators/{}.hpp", project_directory,
               class_name),
        format("{}/Backboard/Includes/Indicators/{}.hpp", project_directory,
               name_)};
    ...
    const vector<string>& source_candidates = {
        format("{}/Backboard/Sources/Indicators/{}.cpp", project_directory,
               class_name),
        format("{}/Backboard/Sources/Indicators/{}.cpp", project_directory,
               name_)};
