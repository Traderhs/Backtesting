...
export default function ServerAlert({serverError, message}: ServerAlertProps) {
    ...
    return (
        <div
            className="fixed top-0 left-0 right-0 p-4 bg-red-600 text-white z-50 flex items-center justify-center"
            style={{fontSize: '1.2rem', fontFamily: "'Inter', 'Pretendard', sans-serif"}}
        >
